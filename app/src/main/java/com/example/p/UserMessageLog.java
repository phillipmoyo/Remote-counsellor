...
public class UserMessageLog extends SQLiteOpenHelper {
     ...
     * @param context
     */
    public UserMessageLog(Context p, String dbname) {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table USERMESSAGELOG(myId varchar(75) not null,id varchar(75) not null,message varchar(5000) not null,status varchar(20) not null)");
    }
